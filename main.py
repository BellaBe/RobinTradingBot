...
class moneyBot:
    ...
    def __init__(self):
        ...
        for b in info["balances"]:
            if not (b["free"] == "0.00000000") and not (b["free"] == "0.00"):
                print(b)
        self.getIncrements()
    ...
    def loadConfig(self):
        print("\nLoading Config...")
        self.binance_key = cfg.binance["first_api"]
        self.binance_secret = cfg.binance["first_secret"]
    ...
    def output(self, msg):
        #TODO: find a way to send emails through the local host
        # send email
    ...
    def get_trade_fees(self) -> typing.Dict[str, float]:
        return {ticker["symbol"]: ticker["takerCommission"] for ticker in self.client.get_trade_fee()}
